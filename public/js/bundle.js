...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"cadastrar.js":[function(require,module,exports) {
"use strict";
...
var cadastrar = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Usuario criado com sucesso');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function cadastrar(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var stripe = Stripe('pk_test_51IKP7FLtAyPROcDjK2raOHJWSPJTFpiu7QvLfHCE4kieH4kMYf0p3osGfRtzci2g2oIHPDM5OMq1zn2VpAGtFgLt00tFhpDV8q');
...
var _cadastrar = require("./cadastrar");
...
var cadastrarForm = document.querySelector('.cadastrar-form');
...
if (cadastrarForm) cadastrarForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var name = document.getElementById('name').value;
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  var confirmPassword = document.getElementById('confirmPassword').value;
  (0, _cadastrar.cadastrar)(name, email, password, confirmPassword);
});
